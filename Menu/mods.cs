            ...
            if (EasyInputs.GetGripButtonFloat(EasyHand.RightHand) > 0.1f || Mouse.current.rightButton.isPressed)
            {
                        ...
                        -GorillaLocomotion.Player.Instance.rightHandTransform.up, out var hitinfo))
                {
                    ...
                    if (GunSphere == null)
                    {
                        ...
                        {
                            linePositions[i] = GorillaLocomotion.Player.Instance.rightHandTransform.position; // set start positions to controllers position
                        }
                    }
                    ...
                    Vector3 pos1 = GorillaLocomotion.Player.Instance.rightHandTransform.position;  //  controller position
